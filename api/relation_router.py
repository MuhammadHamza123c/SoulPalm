...
from src.couple_image import coup_palm
from store.image_upload import upload_image_to_supabase
import os

router_real=APIRouter()

@router_real.post('/SoulPalm/realtionship')
async def show_realtionship_palm(friend1:str=Form(...), friend2:str=Form(...),f1z:str=Form(...),f2z:str=Form(...),f1:UploadFile=File(...),f2: UploadFile=File(...)):
    ...
    result=coup_palm(image1_url=file_url1,image2_url=file_url2,f1=friend1,f2=friend2,f1z=f1z,f2z=f2z)
    return{
        'SoloPalm':result
    }
